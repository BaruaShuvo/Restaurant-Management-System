...
namespace restaurant_managent_system
{
    ...
    {
        SqlConnection con = new SqlConnection("Data Source=ARIF;Initial Catalog=restaurantdb;Persist Security Info=True;User ID=sa;Password=ewu");
        public ordernow()
        {
            InitializeComponent();
        }
        ...
        {
            // TODO: This line of code loads data into the 'restaurantdbDataSet19.carttbl' table. You can move, or remove it, as needed.
            this.carttblTableAdapter2.Fill(this.restaurantdbDataSet19.carttbl);
            // TODO: This line of code loads data into the 'restaurantdbDataSet18.itemtbl' table. You can move, or remove it, as needed.
            this.itemtblTableAdapter1.Fill(this.restaurantdbDataSet18.itemtbl);
            // TODO: This line of code loads data into the 'restaurantdbDataSet16.ordertbl' table. You can move, or remove it, as needed.
            this.ordertblTableAdapter1.Fill(this.restaurantdbDataSet16.ordertbl);
