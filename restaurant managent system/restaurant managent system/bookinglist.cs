...
namespace restaurant_managent_system
{
    public partial class bookinglist : Form
    {
        ...
        {
            // TODO: This line of code loads data into the 'restaurantdbDataSet9.bookingtbl' table. You can move, or remove it, as needed.
            this.bookingtblTableAdapter2.Fill(this.restaurantdbDataSet9.bookingtbl);
            // TODO: This line of code loads data into the 'restaurantdbDataSet6.bookingtbl' table. You can move, or remove it, as needed.
            this.bookingtblTableAdapter1.Fill(this.restaurantdbDataSet6.bookingtbl);
