        ...
        private void confirmbtn_Click(object sender, EventArgs e)
        {
            ...
            if (customerchkbox.Checked)
            {
                ...
                else
                {
                    ...
                    con.ConnectionString = "Data Source=ARIF;Initial Catalog=restaurantdb;Persist Security Info=True;User ID=sa;Password=ewu";
                    con.Open();
            ...
            else
            {
                ...
                else
                {
                    ...
                    SqlCommand ccmd = new SqlCommand(query, con);
                    ccmd.Parameters.Add("@customerId", id1);
                    ccmd.Parameters.Add("@customerName", cnametxt.Text);
                    ccmd.Parameters.Add("@customerEmail", cemailtxt.Text);
                    ccmd.Parameters.Add("@customerPhoneNo", Convert.ToInt32(cphonetxt.Text));
                    ccmd.Parameters.Add("@customerAddress", caddressrtxt.Text);
